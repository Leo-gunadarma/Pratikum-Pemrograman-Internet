          ...
          <div class="box">
            ...
            <div class="box-body table-responsive no-padding">
              <table class="table table-hover" id="example1">
                ...
                <?php
                  $status = $konfirmasi->status_invoice_id;
                  if($status == 3){
                    continue;
                  }
                  if($status == 4){
                ...
                <tr>
                  ...
                  <td><a class="btn" style="color: blue;" href="{{ url('konfirmasi/terima/'.$konfirmasi->pesanan_id) }}">Valid</a> | <a style="color: red;" href="{{ url('konfirmasi/tolak/'.$konfirmasi->pesanan_id) }}">Tidak Valid</a></td>
                </tr>
                @endforeach
              </tbody>
            </table>
    ...
    $('body').on('click', '.konfirmasi', function(){
      ...
      $.ajax({
        ...
        success : function(data){
          ...
          $.each(data.hasil.product, function(i, v){
            console.log(v);

            var product = '<tr>';

            product += '<td>';
            product += v.nama_product;
            product += '</td>';
