...
@endsection
@section('content')
<h1 class="h3 text-dark">Edit Discount</h1>
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="font-weight-bold text-primary">Ubah Data</h6>
    </div>
    <div class="card-body">
        <form action="/discount-update/{{$product->id}}" method="POST" enctype="multipart/form-data" name="data_diskon"
            id="data_diskon">
            @csrf
            {{ method_field('PUT') }}
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input name="persentase" id="persentase" type="number" onblur="calculate()" class="form-control"
                        placeholder="Masukan nominal persentase (Dalam bentuk angka)" min="0" value="{{$productDiskon->percentage}}">
                    <span class="error text-danger">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input name="start" id="start" type="date" class="date form-control"
                        placeholder="Masukan nominal start (Dalam format tanggal)" min="0" value="{{$productDiskon->start}}">
                    <span class="error text-danger">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input name="end" id="end" type="date" class="date form-control"
                        placeholder="Masukan nominal end (Dalam format tanggal)" min="0" value="{{$productDiskon->end}}">
                    <span class="error text-danger">
                        <h6 id="end_error"></h6>
                    </span>
                </div>
            ...
            <div class="float-right">
                ...
                <a  href="/discount-delete/{{$product->id}}" class="btn btn-danger">
                    <i class="fas fa-trash"></i> Delete Diskon
                </a>
            </div>
        </form>
